    ...
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          ...
          <br />
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Neotrade IDFC FIRST Bank 3-in-1 Account
          </a>
          <br />
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Getting Started
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="">
            <i class="fa fa-user" aria-hidden="true"></i>Your Neotrade Account
          </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Login Credintials
          </a>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="">
            <i class="fa fa-bar-chart" aria-hidden="true"></i> Your Neotrade Account
          </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
